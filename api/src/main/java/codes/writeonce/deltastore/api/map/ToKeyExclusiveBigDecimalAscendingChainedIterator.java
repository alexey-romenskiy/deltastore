...
final class ToKeyExclusiveBigDecimalAscendingChainedIterator<V, T>
        extends AbstractBigDecimalAscendingChainedIterator<V, T> {

    @SuppressWarnings("rawtypes")
    private static final ArrayPool<ToKeyExclusiveBigDecimalAscendingChainedIterator> POOL =
            new ArrayPool<>(POOL_SIZE, ToKeyExclusiveBigDecimalAscendingChainedIterator::new);

    private BigDecimal toKey;

    @SuppressWarnings("unchecked")
    public static <V, T> ToKeyExclusiveBigDecimalAscendingChainedIterator<V, T> create(
            @Nonnull NestedIterator<V, T> iterator, boolean exclusive, @Nonnull BigDecimal toKey) {
        final ToKeyExclusiveBigDecimalAscendingChainedIterator<V, T> value = POOL.get();
    ...
    private ToKeyExclusiveBigDecimalAscendingChainedIterator() {
        // empty
    }
